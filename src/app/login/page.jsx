...
<form onSubmit={handleLogin} className='flex flex-col gap-5 justify-center items-center bg-white text-orange-700 shadow-md p-5 max-w-[50%] mx-auto rounded-lg'>
    <h2 className='my-4 text-3xl font-semibold uppercase'>Login Now</h2>
