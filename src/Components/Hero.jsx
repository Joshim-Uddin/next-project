...
const Hero = () => {
    return (
        <div className='md:h-screen flex md:flex-row flex-col-reverse justify-center gap-5 items-center md:py-12 py-6 md:w-10/12 mx-auto '>
            ...
            <a href="/products"><button className='w-1/3 max-[600px]:mx-auto bg-blue-700 text-white p-2 rounded-md mt-5 hover:bg-red-400 hover:transition'>Visit Shop</button></a>
            </div>
